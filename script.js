...
const jokeUrl = 'https://v2.jokeapi.dev/joke/Programming?blacklistFlags=nsfw,political,racist'
...
function tellJoke(joke){
    ...
    VoiceRSS.speech({
        key: '0da4a5a6091c44eb86b5b392df1eec78',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
let getJoke = async() =>{
    try {
        ...
        if (jokeData.type == 'single'){
            ...
            let joke = `${jokeData.setup}....${jokeData.delivery}`
            tellJoke(joke)
            toggleBtn()
        }
    } catch (error) {
